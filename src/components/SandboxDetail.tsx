      ...
      {tab === "info" && (
        <div style={{ position: "relative" }}>
          ...
          <div className="sandbox-detail-section" style={{ marginBottom: 10 }}>
            ...
            <div className="info-grid">
              <div><span className="info-label">Mount</span><span className="info-value">{sandbox.projectMount || "None"}{sandbox.projectMount && <span style={{ color: "var(--accent)", cursor: "pointer", marginLeft: 4, display: "inline-flex", verticalAlign: "middle" }} onClick={() => window.sandobox.openPath(sandbox.projectMount!)} title="Open folder"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 5a2 2 0 0 1 2-2h3.5L9 5h5a1 1 0 0 1 1 1v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5z"/><path d="M7 9l3-3"/><path d="M10 6H7v3"/></svg></span>}</span></div>
